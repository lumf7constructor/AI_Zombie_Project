...
pygame.display.set_caption("AI Grid 1: BFS Search")
clock = pygame.time.Clock()

# Calculate the path once at the beginning, with exploration info
start_time = time.time()
calculated_path, bfs_info = get_bfs_path(player_pos, goal_pos, GRID, return_info=True)
end_time = time.time()
...
#     try:
#         # Create side-by-side visualization: left = explored, right = path
...
#         ax1.set_title("BFS: Explored Nodes (Light Blue) & Path (Yellow)")
#         ax1.axis('off')
...
#         plt.tight_layout()
#         plt.savefig('/home/lum/AI_Zombie_Project/grid1_bfs_footprint.png', dpi=100, bbox_inches='tight')
#         print("Saved: grid1_bfs_footprint.png")
#         plt.close()
