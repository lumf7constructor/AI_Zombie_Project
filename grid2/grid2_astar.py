...
pygame.display.set_caption("AI Grid 2: A* Search on Large Grid (30x30)")
clock = pygame.time.Clock()

# Calculate the path once at the beginning, with exploration info
start_time = time.time()
calculated_path, astar_info = get_astar_path(player_pos, goal_pos, GRID_LARGE, return_info=True)
end_time = time.time()
