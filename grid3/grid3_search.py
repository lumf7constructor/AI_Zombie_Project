...
pygame.display.set_caption("AI Grid 3: BFS Search on Extra Large Grid (50x40)")
clock = pygame.time.Clock()

# Calculate the path once at the beginning, with exploration info
start_time = time.time()
calculated_path, bfs_info = get_bfs_path(player_pos, goal_pos, GRID_XLARGE, return_info=True)
end_time = time.time()
...
#         ax1.set_title("BFS (Grid 3): Explored Nodes (Light Blue) & Path (Yellow)")
#         ax1.axis('off')
        
#         # Right: Metrics scorecard
#         ax2.axis('off')
#         metrics_text = f"""
# BFS Search Metrics (50x40 Grid)
# {'='*40}
...
#         plt.tight_layout()
#         plt.savefig('/home/lum/AI_Zombie_Project/grid3_bfs_footprint.png', dpi=100, bbox_inches='tight')
#         print("Saved: grid3_bfs_footprint.png")
#         plt.close()
